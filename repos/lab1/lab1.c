...
static int proc_args(int argc, char *argv[])
{
	...
	if (strncmp(argv[1], "blank", strlen("blank")) == 0)
	{
		...
		{
			printf(
					"video_txt: wrong no of arguments for test of vt_blank() \n");
			return 1;
		}
	...
	else if (strncmp(argv[1], "fill", strlen("fill")) == 0)
	{
		...
		{
			printf(
					"video_txt: wrong no of arguments for test of vt_fill_char() \n");
			return 1;
		}
	...
	else if (strncmp(argv[1], "char", strlen("char")) == 0)
	{
		...
		{
			printf(
					"video_txt: wrong no of arguments for test of vt_print_char() \n");
			return 1;
		}
		if ((ch = parse_ulong(argv[2], 16)) == ULONG_MAX)
			return 1;
	...
	else if (strncmp(argv[1], "string", strlen("string")) == 0)
	{
		...
		{
			printf(
					"video_txt: wrong no of arguments for test of vt_print_string() \n");
			return 1;
		}
		str = argv[2];
		if ((attr = parse_ulong(argv[3], 16)) == ULONG_MAX)
	...
	else if (strncmp(argv[1], "frame", strlen("frame")) == 0)
	{
		...
		{
			printf(
					"video_txt: wrong no of arguments for test of vt_draw_frame() \n");
			return 1;
		}
